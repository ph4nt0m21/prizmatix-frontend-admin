...
import { GetEventOrdersAPI, GetEventAttendeesAPI, GetEventDashboardAPI, GetEventAPI } from '../../services/allApis';
import { FiTag, FiUsers, FiInfo } from 'react-icons/fi';
import { format } from 'date-fns';
import LoadingSpinner from '../../components/common/loadingSpinner/loadingSpinner';
import OrdersTable from './dashboard/OrdersTable';
import AttendeesTable from './dashboard/AttendeesTable';
import OverviewSection from '../events/sections/overviewSection';
...
export default function EventDetails({ eventId, onBack }) {
  ...
  const renderContent = () => {
    if (activeTab === 'Details') {
      if (detailsLoading) return <div className={pageStyles.loadingContainer}><LoadingSpinner /></div>;
