...
const TicketsStep = ({
            ...
            >
              ...
              {onSoldOutOverrideToggle && isPersistedTicket(ticket) && (
                <button
                  ...
                  disabled={viewOnly || isSavingTickets}
                >
  ...
  const addDonationButton = viewOnly ? null : (
    <button
      type="button"
      className={styles.addTicketInlineButton}
      onClick={handleAddDonationTicketRow}
      disabled={viewOnly || isSavingTickets || hasDonationTicket}
    >
  ...
  const addTicketButton = viewOnly ? null : (
    <button
      type="button"
      className={styles.addTicketInlineButton}
